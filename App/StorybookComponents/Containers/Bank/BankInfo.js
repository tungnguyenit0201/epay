    ...
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.wrap,{paddingBottom: 30}]}>
        ...
        <View style={styles.mb_1}>
          <TextInput placeholder={translation.card_number} style={{borderColor: Colors.cl4, outlineColor: Colors.cl4}}/>
        ...
        <View style={styles.mb_1}>
          <TextInput placeholder={translation.cardholder_name} style={{borderColor: Colors.cl4, outlineColor: Colors.cl4}}/>
        </View>

        <View style={styles.mb_1}>
          <TextInput placeholder={translation.issue_date} style={{borderColor: Colors.cl4, outlineColor: Colors.cl4}}/>
        </View>

        <View style={styles.mb_1}>
          <TextInput placeholder={translation.cvv} style={{borderColor: Colors.cl4, outlineColor: Colors.cl4}}/>
        </View>
        ...
        <SelectInput
          ...
          defaultValue={'cmnd'}
          style={{borderColor: Colors.cl4, outlineColor: Colors.cl4, maxWidth: 320, margin: 'auto'}}
