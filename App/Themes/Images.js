export default {
  ...
  Gradient: {
    ...
    B_Login: require('images/gradient/B_login.png'),
    B_loginDisabled: require('images/gradient/B_login_disable.png'),
    B_Register: require('images/gradient/B_register.png'),
    B_registerDisable: require('images/gradient/B_register_disable.png'),
    B_Done: require('images/gradient/B_done.png'),
    B_doneDisable: require('images/gradient/B_done_disable.png'),
  ...
  Storybook: {
    Close: require('images/storybook/close.png'),
    Eye: require('images/storybook/eye.png'),
    EyeGray: require('images/storybook/eye-slash.png'),
    Airport: require('images/storybook/airport.png'),
