...
import { View, FlatList, StyleSheet, useWindowDimensions, TouchableOpacity, ScrollView, Image } from 'react-native';
import { useContacts } from 'context/Wallet/utils';
import { FWLoading, Header, Text, TextInput, Icon, Button, Row, Col } from 'components';
            ...
            <HeaderBg>
                ...
                <View>
                    ...
                    <View style={styles.blockUser}>
                        <Image
                            source={Images.Transfer.User_1}
                            style={styles.avatar}
                        />
                        <View style={styles.ml_20}>
                            <Text bold style={styles.nameUser}>Nguyen Van An</Text>
            ...
            <View style={styles.flexBox}>
                <View style={styles.wrap}>
                    ...
                    <View>
                        ...
                        />
                        <Text bold style={styles.textCurrent}>vnđ</Text>
                    </View>
                    {/* Input with Text */}
                    <TextInput
                    ...
                    />
                    {/* Icon Rectangle */}
                    <Text bold style={styles.textH6}>{translation.transfer_by_epay}</Text>

                    <View style={{ marginBottom: scale(20) }}>
                        <View style={styles.emptyWallet}>
                            <Image style={styles.iconWallet}
                    ...
                    <Text bold style={styles.sendBank}>Chuyển tiền bằng TK Ngân hàng</Text>
