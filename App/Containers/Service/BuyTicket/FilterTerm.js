...
import {Text, Icon, DatePicker, Row, Col, InputBlock} from 'components';
  ...
  return (
    <>
      <View style={base.container}>
        ...
        <Row space={16} style={styles.mb2}>
          <Col width="50%" space={16}>
            <InputBlock
      ...
      <Calendar
        ...
        hideArrows
        theme={{textSectionTitleColor: Colors.tp2}}
      />
    </>
  );
};
